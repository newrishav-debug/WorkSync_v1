                  ...
                  todaysEvents.map(event => {
                    ...
                    return (
                      <div 
                        ...
                        className={`p-3 rounded-lg border-l-4 cursor-pointer hover:shadow-md transition-all group/meeting ${
                        isCurrent ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-500' :
