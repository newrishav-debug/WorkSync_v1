...
import { Engagement, EngagementStatus, TimelineEntry, EngagementFile, Task, Subtask } from '../types';
import Timeline from './Timeline';
import { generateEngagementSummary } from '../services/geminiService';
import { ArrowLeft, Plus, Sparkles, Building2, Hash, Calendar, Loader2, Paperclip, Upload, FileText, File as FileIcon, Trash2, CheckSquare, Circle, CheckCircle2, X } from 'lucide-react';
