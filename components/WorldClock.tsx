              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className={`text-[10px] font-bold uppercase tracking-wider whitespace-nowrap ${
                    isLocal ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-500'
                  }`}>
                    {tz.city}
                  </span>
                  {isLocal && (
                ...
                <div className="flex items-baseline gap-1.5">
                  <span className={`text-sm font-bold font-mono whitespace-nowrap ${
                    isLocal ? 'text-indigo-900 dark:text-indigo-100' : 'text-slate-800 dark:text-slate-200'
                  }`}>
