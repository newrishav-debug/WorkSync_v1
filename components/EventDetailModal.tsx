...
import { X, Calendar as CalendarIcon, Clock, Briefcase, CheckSquare, Save, Trash2, Edit2 } from 'lucide-react';
                     ...
                     {isEditingDateTime ? (
                        <div className="space-y-3">
                           ...
                           <div className="flex items-center gap-2">
                              ...
                              <input
                                 ...
                                 className="flex-1 px-2 py-1.5 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none text-slate-700 dark:text-slate-200"
                              />
                           </div>
                           {/* Editable Time */}
                           <div className="flex items-center gap-2">
                        ...
                        <>
                           <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
                              ...
                              {new Date(editDate + 'T00:00:00').toLocaleDateString(undefined, { weekday: 'short', month: 'short', day: 'numeric' })}
                           </div>
                           <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
                           ...
                           >
                              <Edit2 size={12} /> Edit date/time
                           </button>
                        </>
                     )}
                  </div>
                  <span className={`px-2 py-1 rounded-lg text-xs font-bold uppercase tracking-wide border ${event.type === 'meeting' ? 'bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-300' :
