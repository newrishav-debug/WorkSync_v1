...
import { Plus, FolderKanban, Trash2, Calendar, CheckSquare, Square, X, ChevronDown, MoreVertical, ArrowLeft, BookOpen, Clock, PenTool, Lightbulb, Briefcase } from 'lucide-react';
    ...
    return (
      <div className="w-full space-y-6 animate-fade-in">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
          ...
          {/* Source Lineage - Show if project was created from an idea */}
          {activeProject.sourceIdeaId && (
            <div className="mb-6 p-4 bg-gradient-to-r from-amber-50 to-indigo-50 dark:from-amber-900/10 dark:to-indigo-900/10 rounded-lg border border-amber-100 dark:border-amber-800/30">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  <span className="text-slate-500 dark:text-slate-400">Source Idea:</span>
                  <span className="text-amber-700 dark:text-amber-400 font-medium">{activeProject.sourceIdeaTitle || 'Untitled Idea'}</span>
                </div>
                {activeProject.sourceEngagementId && (
                  <div className="flex items-center gap-2">
                    <Briefcase size={14} className="text-slate-400" />
                    <span className="text-slate-500 dark:text-slate-400">From Engagement:</span>
                    <span className="text-indigo-700 dark:text-indigo-400 font-medium">{activeProject.sourceEngagementName || 'Unknown'}</span>
                  </div>
                )}
              </div>
            </div>
